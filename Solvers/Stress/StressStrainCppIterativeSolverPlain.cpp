...
StressStrainCppIterativeSolverPlain::StressStrainCppIterativeSolverPlain
	(
		double* params, 
		int* links, 
		int nLinks, 
...
void StressStrainCppIterativeSolverPlain::Solve(const int nIterations)
{
...
void StressStrainCppIterativeSolverPlain::SolveFull(const int nIterations)
{
//	Solve(nIterations);
...
#pragma omp parallel for num_threads(_numThreads)
	...
	// virtual
void StressStrainCppIterativeSolverPlain::InitialSolve()
{
...
*/
// virtual
void StressStrainCppIterativeSolverPlain::Solve1()
{
	_MM_SET_FLUSH_ZERO_MODE(_MM_FLUSH_ZERO_ON);
	MeasuredRun(1, _rotationSolver->Solve1());
	MeasuredRun(2, CalculateForces());
...
*/
// virtual
void StressStrainCppIterativeSolverPlain::Solve2()
{
	_MM_SET_FLUSH_ZERO_MODE(_MM_FLUSH_ZERO_ON);
...
*/
// virtual
void StressStrainCppIterativeSolverPlain::Solve3()
{
	_MM_SET_FLUSH_ZERO_MODE(_MM_FLUSH_ZERO_ON);
...
*/
// virtual
void StressStrainCppIterativeSolverPlain::Solve4()
{
	_MM_SET_FLUSH_ZERO_MODE(_MM_FLUSH_ZERO_ON);
...
*/
// virtual
void StressStrainCppIterativeSolverPlain::Solve5()
{
	_MM_SET_FLUSH_ZERO_MODE(_MM_FLUSH_ZERO_ON);
...
*/
// virtual
void StressStrainCppIterativeSolverPlain::GetDisplacement
	(
		float* data
	)
{
...
*/
// virtual
void StressStrainCppIterativeSolverPlain::GetStressesByFirstTheoryOfStrength
	(
		float* data
	)
{
...
*/
// virtual
void StressStrainCppIterativeSolverPlain::GetStressesX(float* data)
{
#ifdef OMP_SOLVE
#pragma omp parallel for num_threads(_numThreads)
#endif
...
*/
// virtual
void StressStrainCppIterativeSolverPlain::GetStressesY(float* data)
{
#ifdef OMP_SOLVE
#pragma omp parallel for num_threads(_numThreads)
#endif
...
*/
// virtual
void StressStrainCppIterativeSolverPlain::GetStressesZ(float* data)
{
#ifdef OMP_SOLVE
#pragma omp parallel for num_threads(_numThreads)
#endif
...
*/
// virtual
void StressStrainCppIterativeSolverPlain::GetStressesXY(float* data)
{
#ifdef OMP_SOLVE
#pragma omp parallel for num_threads(_numThreads)
#endif
...
*/
// virtual
void StressStrainCppIterativeSolverPlain::GetStressesXZ(float* data)
{
#ifdef OMP_SOLVE
#pragma omp parallel for num_threads(_numThreads)
#endif
...
*/
// virtual
void StressStrainCppIterativeSolverPlain::GetStressesYZ(float* data)
{
#ifdef OMP_SOLVE
#pragma omp parallel for num_threads(_numThreads)
#endif
...
*/
// virtual
void StressStrainCppIterativeSolverPlain::GetStressesByVonMises
	(
		float* data
	)
{
...
void StressStrainCppIterativeSolverPlain::CalculateStrains
(
...
void StressStrainCppIterativeSolverPlain::CalculateStrainsUa
(
size_t side,			// 0 = -x, 1 = x, 2 = -y, 3 = y, 4 = -z, 5 = z
double *shiftStrains,		// выход деформаций
double *velocityStrains,	// выход изм. скоростей
